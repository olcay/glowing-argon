...
namespace Ookgewoon.Web.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ParentCategoryId,Name,Type")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ParentCategoryId,Name,Type")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
